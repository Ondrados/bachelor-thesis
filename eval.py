...
if __name__ == "__main__":
    ...
    f_precision, f_recall, f_dice, f_dice_vec = faster_evaluate(faster, faster_eval_loader, dist_threshold=5)
    ...
    y_precision, y_recall, y_dice, y_dice_vec = yolo_evaluate(yolo, yolo_eval_loader, dist_threshold=5)
    ...
    u_precision, u_recall, u_dice, u_dice_vec = unet_evaluate(unet, unet_eval_loader, dist_threshold=5)
